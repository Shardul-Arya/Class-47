...
function setup() {
    ...
    backgr0und2 = createSprite(600, 1075, 1200, 700);
    backgr0und2.addImage(backgroundImage2)
    backgr0und2.scale = 1.1
    ...
    box1 = createSprite(600, 1400, 1500,20);
    box1.shapeColor = rgb(250, 50, 50);
    box2 = createSprite(600, 700, 1500,20);
    box2.shapeColor = rgb(250, 50, 50);
    box3 = createSprite(0, 1050, 20,700);
    box3.shapeColor = rgb(250, 50, 50)
    box4 = createSprite(1200, 1050, 20,700);
    box4.shapeColor = rgb(250, 50, 50)
    ...
    alien = createSprite(950, 100, 30, 50);
...
function draw() {
    ...
    fill("black");
    textSize(50);
    text("You Finished Level 1", 2760, 300);
    ...
    text("Press R to try again", 1600, 400);
    if (gameState === "play") {
        spawnRocket();
        alien.addImage(alienImage);
